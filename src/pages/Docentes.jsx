      ...
      <div className="doc-page page-container">
        ...
        <div className="doc-stats-bar">
          ...
          <div className="doc-stat-chip green">
            <span style={{ width:8, height:8, borderRadius:"50%", background:"#16a34a", display:"inline-block", animation:"blink-dot 1.8s infinite" }} />
  ...
  return (
    <div className="doc-card" style={{ animationDelay:`${delay}s` }} onClick={onOpen}>
      ...
      <div className="doc-stats-strip">
        ...
        <div className="doc-ss">
          <span className="doc-ss-num">{d.totalDescargas > 999 ? `${(d.totalDescargas/1000).toFixed(1)}k` : d.totalDescargas}</span>
          <span className="doc-ss-lbl">Descargas</span>
        </div>
      </div>
      ...
      {/* ← CAMBIO: pasamos docenteId al navegar */}
      <div className="doc-card-footer" onClick={(e) => e.stopPropagation()}>
        <button
          className="doc-action-btn"
          onClick={() => navigate("apuntes", { docenteId: String(d.id) })}
        >
          📝 Apuntes
        </button>
        <button
          className="doc-action-btn"
          onClick={() => navigate("examenes", { docenteId: String(d.id) })}
        >
          📋 Exámenes
        </button>
        <button
  ...
  return (
    <div className="doc-modal-backdrop" onClick={onClose}>
      <div className="doc-modal-box" onClick={(e) => e.stopPropagation()}>
        ...
        {/* ← CAMBIO: pasamos docenteId al navegar desde el modal */}
        <div className="doc-modal-cta">
          <button
            className="doc-modal-btn doc-modal-btn-primary"
            onClick={() => { onClose(); navigate("apuntes", { docenteId: String(d.id) }); }}
          >
            📝 Ver apuntes
          </button>
          <button
            className="doc-modal-btn doc-modal-btn-secondary"
            onClick={() => { onClose(); navigate("examenes", { docenteId: String(d.id) }); }}
          >
            📋 Ver exámenes
          </button>
        </div>
